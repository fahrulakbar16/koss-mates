        ...
        <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-6 mb-2">
            <div>
                ...
                <p class="text-gray-600 dark:text-gray-400 text-base ml-5">
                    Tambahkan data kos baru ke dalam sistem
                </p>
            </div>
        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="space-y-2">
                                ...
                                <select id="owner_id" v-model="form.owner_id" required
                                    ...
                                    <option value="" disabled hidden>Pilih pemilik</option>
                            ...
                            <div class="space-y-2 md:col-span-2">
                                ...
                                <select id="cluster_id" v-model="form.cluster_id"
                                    :disabled="!!props.cluster_id"
                                    class="w-full px-4 py-2.5 text-sm font-medium text-gray-900 bg-gray-50 border border-gray-200 rounded-xl focus:bg-white focus:border-primary-500 focus:ring-4 focus:ring-primary-500/10 transition-all duration-200 dark:bg-gray-800 dark:border-gray-700 dark:text-white dark:focus:border-primary-500 disabled:opacity-50 disabled:cursor-not-allowed">
                    ...
                    <div class="border-b border-gray-100 dark:border-gray-700 pb-8 last:border-0 last:pb-0">
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="flex flex-col sm:flex-row items-stretch gap-6">
                                ...
                                <!-- Preview Area -->
                                <div v-if="thumbnailPreview" class="relative group shrink-0 w-full sm:w-auto flex justify-center sm:block">
                                    <label for="thumbnail"
                                        class="cursor-pointer w-48 h-48 sm:w-64 sm:h-64 block rounded-2xl overflow-hidden border-4 border-white dark:border-gray-800 shadow-lg relative bg-gray-100 dark:bg-gray-900">
                                        ...
                                        <label for="thumbnail"
                                            ...
                                            <div class="flex flex-col items-center justify-center pt-5 pb-6 px-4 text-center">
                                                <div class="p-4 bg-white dark:bg-gray-800 rounded-full shadow-sm mb-4 group-hover:scale-110 group-hover:shadow-md transition-all duration-300 border border-gray-100 dark:border-gray-700">
                                                    <svg class="w-8 h-8 text-primary-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 16">
...
const breadcrumbs = [
    { label: "Properti" },
    { label: "Cluster", href: route("clusters.index") },
    { label: "Tambah Kos" },
];
...
onMounted(() => {
    if (props.cluster_id) {
        form.cluster_id = props.cluster_id;
    }
