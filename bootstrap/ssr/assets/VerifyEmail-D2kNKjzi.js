...
import { _ as _sfc_main$2 } from "./AuthenticationCardLogo-CA28ODL_.js";
import { _ as _sfc_main$1 } from "./PrimaryButton-6XL3S92Y.js";
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<!--[-->`);
      _push(ssrRenderComponent(unref(head_default), { title: "Email Verification" }, null, _parent));
