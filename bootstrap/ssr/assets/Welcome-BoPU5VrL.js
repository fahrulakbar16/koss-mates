...
const seoTitle = "KosMates - Temukan Kos Ideal Anda dengan Mudah";
  ...
  setup(__props) {
    ...
    const organizationStructuredData = computed(() => {
      return JSON.stringify({
        ...
        name: "KosMates",
        url: siteUrl.value,
        logo: `${siteUrl.value}/images/logo/KosMates-logo.png`,
        description: seoDescription,
        sameAs: [
          "https://www.facebook.com/KosMates",
          "https://www.instagram.com/KosMates",
          "https://twitter.com/KosMates"
        ],
        contactPoint: {
          "@type": "ContactPoint",
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(unref(head_default), { title: seoTitle }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<meta name="title"${ssrRenderAttr("content", seoTitle)} data-v-b4fbfa7e${_scopeId}><meta name="description"${ssrRenderAttr("content", seoDescription)} data-v-b4fbfa7e${_scopeId}><meta name="keywords"${ssrRenderAttr("content", seoKeywords)} data-v-b4fbfa7e${_scopeId}><meta name="author" content="KosMates" data-v-b4fbfa7e${_scopeId}><meta name="robots" content="index, follow" data-v-b4fbfa7e${_scopeId}><meta name="language" content="Indonesian" data-v-b4fbfa7e${_scopeId}><meta name="revisit-after" content="7 days" data-v-b4fbfa7e${_scopeId}><link rel="canonical"${ssrRenderAttr("href", siteUrl.value)} data-v-b4fbfa7e${_scopeId}><meta property="og:type" content="website" data-v-b4fbfa7e${_scopeId}><meta property="og:url"${ssrRenderAttr("content", siteUrl.value)} data-v-b4fbfa7e${_scopeId}><meta property="og:title"${ssrRenderAttr("content", seoTitle)} data-v-b4fbfa7e${_scopeId}><meta property="og:description"${ssrRenderAttr("content", seoDescription)} data-v-b4fbfa7e${_scopeId}><meta property="og:image"${ssrRenderAttr("content", seoImage.value)} data-v-b4fbfa7e${_scopeId}><meta property="og:image:width" content="1200" data-v-b4fbfa7e${_scopeId}><meta property="og:image:height" content="630" data-v-b4fbfa7e${_scopeId}><meta property="og:image:alt" content="KosMates - Platform Pencarian Kos Terpercaya" data-v-b4fbfa7e${_scopeId}><meta property="og:site_name" content="KosMates" data-v-b4fbfa7e${_scopeId}><meta property="og:locale" content="id_ID" data-v-b4fbfa7e${_scopeId}><meta name="twitter:card" content="summary_large_image" data-v-b4fbfa7e${_scopeId}><meta name="twitter:url"${ssrRenderAttr("content", siteUrl.value)} data-v-b4fbfa7e${_scopeId}><meta name="twitter:title"${ssrRenderAttr("content", seoTitle)} data-v-b4fbfa7e${_scopeId}><meta name="twitter:description"${ssrRenderAttr("content", seoDescription)} data-v-b4fbfa7e${_scopeId}><meta name="twitter:image"${ssrRenderAttr("content", seoImage.value)} data-v-b4fbfa7e${_scopeId}><meta name="twitter:image:alt" content="KosMates - Platform Pencarian Kos Terpercaya" data-v-b4fbfa7e${_scopeId}><meta name="theme-color" content="#fa5252" data-v-b4fbfa7e${_scopeId}><meta name="apple-mobile-web-app-capable" content="yes" data-v-b4fbfa7e${_scopeId}><meta name="apple-mobile-web-app-status-bar-style" content="black-translucent" data-v-b4fbfa7e${_scopeId}><meta name="format-detection" content="telephone=no" data-v-b4fbfa7e${_scopeId}>`);
            ...
            return [
              ...
              createVNode("meta", {
                ...
                content: "KosMates - Platform Pencarian Kos Terpercaya"
              }),
              createVNode("meta", {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            return [
              ...
              createVNode("h1", { class: "text-xl font-bold text-gray-900 dark:text-white" }, "KosMates")
            ];
          }
        }),
        _: 1
